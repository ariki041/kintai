...
<div class="container">
	...
	<div class="row" id="header">
		<div class="col-md-2 col-md-offset-10 col-xs-offset-7">
			<button type="button" class="btn btn-primary" id="addStaff" onClick="location.href='/kintai/Admin/stafftoroku'">スタッフ追加</button>
		</div>
	</div>
	...
	<div class="table-responsive">
		<table class="table table-bordered table-condensed table-hover table-striped">
			...
			<tbody>
				...
				<tr>
					<td><!--{$staff[staff]['User']['staff_name']}--></td>
					<td><!--{$staff[staff]['User']['mail_address']}--></td>
					<form method="get" action="/kintai/Admin/syukkinjyokyo">
						<td><button type="submit" class="btn" name="user" value="<!--{$staff[staff]['User']['mail_address']}-->">出勤状況</button></td>
					</form>
					<form method="get" action="/kintai/Admin/stafftoroku">
